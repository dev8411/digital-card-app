...
// tests for CardholderAddressResponse
void main() {
  final instance = CardholderAddressResponseBuilder();
  // TODO add properties to the builder and call build()

  group(CardholderAddressResponse, () {
    ...
    // bool isDefaultAddress (default value: false)
    test('to test the property `isDefaultAddress`', () async {
      // TODO
    });
