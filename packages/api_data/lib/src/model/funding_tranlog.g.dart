...
part of 'funding_tranlog.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_PENDING =
    const FundingTranlogTransactionStateEnum._('PENDING');
const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_CLEARED =
    const FundingTranlogTransactionStateEnum._('CLEARED');
const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_COMPLETION =
    const FundingTranlogTransactionStateEnum._('COMPLETION');
const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_DECLINED =
    const FundingTranlogTransactionStateEnum._('DECLINED');
const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_ERROR =
    const FundingTranlogTransactionStateEnum._('ERROR');
const FundingTranlogTransactionStateEnum
    _$fundingTranlogTransactionStateEnum_ALL =
    const FundingTranlogTransactionStateEnum._('ALL');

FundingTranlogTransactionStateEnum _$fundingTranlogTransactionStateEnumValueOf(
    String name) {
  switch (name) {
    case 'PENDING':
      return _$fundingTranlogTransactionStateEnum_PENDING;
    case 'CLEARED':
      return _$fundingTranlogTransactionStateEnum_CLEARED;
    case 'COMPLETION':
      return _$fundingTranlogTransactionStateEnum_COMPLETION;
    case 'DECLINED':
      return _$fundingTranlogTransactionStateEnum_DECLINED;
    case 'ERROR':
      return _$fundingTranlogTransactionStateEnum_ERROR;
    case 'ALL':
      return _$fundingTranlogTransactionStateEnum_ALL;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<FundingTranlogTransactionStateEnum>
    _$fundingTranlogTransactionStateEnumValues = new BuiltSet<
        FundingTranlogTransactionStateEnum>(const <FundingTranlogTransactionStateEnum>[
  _$fundingTranlogTransactionStateEnum_PENDING,
  _$fundingTranlogTransactionStateEnum_CLEARED,
  _$fundingTranlogTransactionStateEnum_COMPLETION,
  _$fundingTranlogTransactionStateEnum_DECLINED,
...
Serializer<FundingTranlogTransactionStateEnum>
    _$fundingTranlogTransactionStateEnumSerializer =
    new _$FundingTranlogTransactionStateEnumSerializer();

class _$FundingTranlogTransactionStateEnumSerializer
    implements PrimitiveSerializer<FundingTranlogTransactionStateEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[FundingTranlogTransactionStateEnum];
  @override
  final String wireName = 'FundingTranlogTransactionStateEnum';

  @override
  Object serialize(
          Serializers serializers, FundingTranlogTransactionStateEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  FundingTranlogTransactionStateEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      FundingTranlogTransactionStateEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$FundingTranlog extends FundingTranlog {
  @override
  ...
  @override
  final FundingTranlogTransactionStateEnum? transactionState;
  @override
  ...
  @override
  final InternalGPAOrder gpaorder;
  @override
  final InternalGatewayLog gatewayLog;

  factory _$FundingTranlog([void Function(FundingTranlogBuilder)? updates]) =>
      (new FundingTranlogBuilder()..update(updates))._build();
  ...
  _$FundingTranlog._(
      ...
      this.originator,
      this.acquirer,
      required this.gpaorder,
      required this.gatewayLog})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        transactionType, r'FundingTranlog', 'transactionType');
    BuiltValueNullFieldError.checkNotNull(token, r'FundingTranlog', 'token');
    BuiltValueNullFieldError.checkNotNull(node, r'FundingTranlog', 'node');
    BuiltValueNullFieldError.checkNotNull(
        network, r'FundingTranlog', 'network');
    BuiltValueNullFieldError.checkNotNull(
        subNetwork, r'FundingTranlog', 'subNetwork');
    BuiltValueNullFieldError.checkNotNull(
        gpaorder, r'FundingTranlog', 'gpaorder');
    BuiltValueNullFieldError.checkNotNull(
        gatewayLog, r'FundingTranlog', 'gatewayLog');
  }

  @override
  FundingTranlog rebuild(void Function(FundingTranlogBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FundingTranlogBuilder toBuilder() =>
      new FundingTranlogBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FundingTranlog &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, gpaorder.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FundingTranlog')
          ...
          ..add('gpaorder', gpaorder)
          ..add('gatewayLog', gatewayLog))
        .toString();
  }
}

class FundingTranlogBuilder
    implements Builder<FundingTranlog, FundingTranlogBuilder> {
  _$FundingTranlog? _$v;
  ...
  FundingTranlogTransactionStateEnum? _transactionState;
  FundingTranlogTransactionStateEnum? get transactionState =>
      _$this._transactionState;
  set transactionState(FundingTranlogTransactionStateEnum? transactionState) =>
  ...
  InternalGPAOrderBuilder? _gpaorder;
  InternalGPAOrderBuilder get gpaorder =>
      _$this._gpaorder ??= new InternalGPAOrderBuilder();
  set gpaorder(InternalGPAOrderBuilder? gpaorder) =>
      _$this._gpaorder = gpaorder;

  InternalGatewayLogBuilder? _gatewayLog;
  InternalGatewayLogBuilder get gatewayLog =>
      _$this._gatewayLog ??= new InternalGatewayLogBuilder();
  set gatewayLog(InternalGatewayLogBuilder? gatewayLog) =>
      _$this._gatewayLog = gatewayLog;

  FundingTranlogBuilder() {
    FundingTranlog._defaults(this);
  }

  FundingTranlogBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      ...
      _gpaorder = $v.gpaorder.toBuilder();
  ...
  @override
  void replace(FundingTranlog other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$FundingTranlog;
  }

  @override
  void update(void Function(FundingTranlogBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  FundingTranlog build() => _build();

  _$FundingTranlog _build() {
    _$FundingTranlog _$result;
    try {
      _$result = _$v ??
          new _$FundingTranlog._(
              returnedBalances: returnedBalances,
              tags: tags,
              transactionType: BuiltValueNullFieldError.checkNotNull(
                  transactionType, r'FundingTranlog', 'transactionType'),
              token: BuiltValueNullFieldError.checkNotNull(
                  token, r'FundingTranlog', 'token'),
              refTransaction: _refTransaction?.build(),
              node: BuiltValueNullFieldError.checkNotNull(
                  node, r'FundingTranlog', 'node'),
              network: BuiltValueNullFieldError.checkNotNull(
                  network, r'FundingTranlog', 'network'),
              subNetwork: BuiltValueNullFieldError.checkNotNull(
                  subNetwork, r'FundingTranlog', 'subNetwork'),
              mid: mid,
              tid: tid,
              stan: stan,
              ...
              acquirer: acquirer,
              gpaorder: gpaorder.build(),
              gatewayLog: gatewayLog.build());
    } catch (_) {
      ...
      try {
        ...
        _$failedField = 'gpaorder';
        gpaorder.build();
        _$failedField = 'gatewayLog';
        gatewayLog.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'FundingTranlog', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
