...
/// * [transactionToken] 
@BuiltValue()
abstract class MsaReturns implements Built<MsaReturns, MsaReturnsBuilder> {
  ...
  factory MsaReturns([void updates(MsaReturnsBuilder b)]) = _$MsaReturns;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MsaReturnsBuilder b) => b
      ..active = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<MsaReturns> get serializer => _$MsaReturnsSerializer();
}

class _$MsaReturnsSerializer implements PrimitiveSerializer<MsaReturns> {
  @override
  final Iterable<Type> types = const [MsaReturns, _$MsaReturns];

  @override
  final String wireName = r'MsaReturns';
  ...
  void _deserializeProperties(
    ...
    required MsaReturnsBuilder result,
  ...
  @override
  MsaReturns deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MsaReturnsBuilder();
