...
part of 'user_card_holder_update_model.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const UserCardHolderUpdateModelGenderEnum
    _$userCardHolderUpdateModelGenderEnum_F =
    const UserCardHolderUpdateModelGenderEnum._('F');
const UserCardHolderUpdateModelGenderEnum
    _$userCardHolderUpdateModelGenderEnum_M =
    const UserCardHolderUpdateModelGenderEnum._('M');

UserCardHolderUpdateModelGenderEnum
    _$userCardHolderUpdateModelGenderEnumValueOf(String name) {
  switch (name) {
    case 'F':
      return _$userCardHolderUpdateModelGenderEnum_F;
    case 'M':
      return _$userCardHolderUpdateModelGenderEnum_M;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<UserCardHolderUpdateModelGenderEnum>
    _$userCardHolderUpdateModelGenderEnumValues = new BuiltSet<
        UserCardHolderUpdateModelGenderEnum>(const <UserCardHolderUpdateModelGenderEnum>[
  _$userCardHolderUpdateModelGenderEnum_F,
  _$userCardHolderUpdateModelGenderEnum_M,
]);

Serializer<UserCardHolderUpdateModelGenderEnum>
    _$userCardHolderUpdateModelGenderEnumSerializer =
    new _$UserCardHolderUpdateModelGenderEnumSerializer();

class _$UserCardHolderUpdateModelGenderEnumSerializer
    implements PrimitiveSerializer<UserCardHolderUpdateModelGenderEnum> {
  ...
  @override
  final String wireName = 'UserCardHolderUpdateModelGenderEnum';

  @override
  Object serialize(
          Serializers serializers, UserCardHolderUpdateModelGenderEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  UserCardHolderUpdateModelGenderEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      UserCardHolderUpdateModelGenderEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$UserCardHolderUpdateModel extends UserCardHolderUpdateModel {
  @override
  final String? token;
  @override
  final bool? active;
  ...
  @override
  final UserCardHolderUpdateModelGenderEnum? gender;
  @override
  ...
  factory _$UserCardHolderUpdateModel(
          [void Function(UserCardHolderUpdateModelBuilder)? updates]) =>
      (new UserCardHolderUpdateModelBuilder()..update(updates))._build();

  _$UserCardHolderUpdateModel._(
      {this.token,
      this.active,
      this.notes,
      this.ipAddress,
  ...
  @override
  UserCardHolderUpdateModel rebuild(
          void Function(UserCardHolderUpdateModelBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UserCardHolderUpdateModelBuilder toBuilder() =>
      new UserCardHolderUpdateModelBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserCardHolderUpdateModel &&
        token == other.token &&
        active == other.active &&
        notes == other.notes &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UserCardHolderUpdateModel')
          ..add('token', token)
          ..add('active', active)
          ..add('notes', notes)
...
class UserCardHolderUpdateModelBuilder
    implements
        Builder<UserCardHolderUpdateModel, UserCardHolderUpdateModelBuilder> {
  _$UserCardHolderUpdateModel? _$v;
  ...
  UserCardHolderUpdateModelGenderEnum? _gender;
  UserCardHolderUpdateModelGenderEnum? get gender => _$this._gender;
  set gender(UserCardHolderUpdateModelGenderEnum? gender) =>
  ...
  UserCardHolderUpdateModelBuilder() {
    UserCardHolderUpdateModel._defaults(this);
  }

  UserCardHolderUpdateModelBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _token = $v.token;
      _active = $v.active;
  ...
  @override
  void replace(UserCardHolderUpdateModel other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UserCardHolderUpdateModel;
  }

  @override
  void update(void Function(UserCardHolderUpdateModelBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UserCardHolderUpdateModel build() => _build();

  _$UserCardHolderUpdateModel _build() {
    _$UserCardHolderUpdateModel _$result;
    try {
      _$result = _$v ??
          new _$UserCardHolderUpdateModel._(
              token: token,
              active: active,
              notes: notes,
              ipAddress: ipAddress,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'UserCardHolderUpdateModel', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
