...
part of 'business_card_holder_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$BusinessCardHolderUpdate extends BusinessCardHolderUpdate {
  @override
  final String? token;
  @override
  final bool? active;
  ...
  @override
  final AddressRequestModel? officeLocation;
  @override
  ...
  @override
  final BusinessIncorporation? incorporation;
  @override
  final BusinessProprietor? proprietorOrOfficer;
  @override
  final BeneficialOwnerRequest? beneficialOwner1;
  @override
  final BeneficialOwnerRequest? beneficialOwner2;
  @override
  final BeneficialOwnerRequest? beneficialOwner3;
  @override
  final BeneficialOwnerRequest? beneficialOwner4;
  @override
  ...
  factory _$BusinessCardHolderUpdate(
          [void Function(BusinessCardHolderUpdateBuilder)? updates]) =>
      (new BusinessCardHolderUpdateBuilder()..update(updates))._build();

  _$BusinessCardHolderUpdate._(
      {this.token,
      this.active,
      this.notes,
      this.ipAddress,
  ...
  @override
  BusinessCardHolderUpdate rebuild(
          void Function(BusinessCardHolderUpdateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BusinessCardHolderUpdateBuilder toBuilder() =>
      new BusinessCardHolderUpdateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BusinessCardHolderUpdate &&
        token == other.token &&
        active == other.active &&
        notes == other.notes &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BusinessCardHolderUpdate')
          ..add('token', token)
          ..add('active', active)
          ..add('notes', notes)
...
class BusinessCardHolderUpdateBuilder
    implements
        Builder<BusinessCardHolderUpdate, BusinessCardHolderUpdateBuilder> {
  _$BusinessCardHolderUpdate? _$v;
  ...
  AddressRequestModelBuilder? _officeLocation;
  AddressRequestModelBuilder get officeLocation =>
      _$this._officeLocation ??= new AddressRequestModelBuilder();
  set officeLocation(AddressRequestModelBuilder? officeLocation) =>
  ...
  BusinessIncorporationBuilder? _incorporation;
  BusinessIncorporationBuilder get incorporation =>
      _$this._incorporation ??= new BusinessIncorporationBuilder();
  set incorporation(BusinessIncorporationBuilder? incorporation) =>
      _$this._incorporation = incorporation;

  BusinessProprietorBuilder? _proprietorOrOfficer;
  BusinessProprietorBuilder get proprietorOrOfficer =>
      _$this._proprietorOrOfficer ??= new BusinessProprietorBuilder();
  set proprietorOrOfficer(BusinessProprietorBuilder? proprietorOrOfficer) =>
      _$this._proprietorOrOfficer = proprietorOrOfficer;

  BeneficialOwnerRequestBuilder? _beneficialOwner1;
  BeneficialOwnerRequestBuilder get beneficialOwner1 =>
      _$this._beneficialOwner1 ??= new BeneficialOwnerRequestBuilder();
  set beneficialOwner1(BeneficialOwnerRequestBuilder? beneficialOwner1) =>
      _$this._beneficialOwner1 = beneficialOwner1;

  BeneficialOwnerRequestBuilder? _beneficialOwner2;
  BeneficialOwnerRequestBuilder get beneficialOwner2 =>
      _$this._beneficialOwner2 ??= new BeneficialOwnerRequestBuilder();
  set beneficialOwner2(BeneficialOwnerRequestBuilder? beneficialOwner2) =>
      _$this._beneficialOwner2 = beneficialOwner2;

  BeneficialOwnerRequestBuilder? _beneficialOwner3;
  BeneficialOwnerRequestBuilder get beneficialOwner3 =>
      _$this._beneficialOwner3 ??= new BeneficialOwnerRequestBuilder();
  set beneficialOwner3(BeneficialOwnerRequestBuilder? beneficialOwner3) =>
      _$this._beneficialOwner3 = beneficialOwner3;

  BeneficialOwnerRequestBuilder? _beneficialOwner4;
  BeneficialOwnerRequestBuilder get beneficialOwner4 =>
      _$this._beneficialOwner4 ??= new BeneficialOwnerRequestBuilder();
  set beneficialOwner4(BeneficialOwnerRequestBuilder? beneficialOwner4) =>
  ...
  BusinessCardHolderUpdateBuilder() {
    BusinessCardHolderUpdate._defaults(this);
  }

  BusinessCardHolderUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _token = $v.token;
      _active = $v.active;
  ...
  @override
  void replace(BusinessCardHolderUpdate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BusinessCardHolderUpdate;
  }

  @override
  void update(void Function(BusinessCardHolderUpdateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BusinessCardHolderUpdate build() => _build();

  _$BusinessCardHolderUpdate _build() {
    _$BusinessCardHolderUpdate _$result;
    try {
      _$result = _$v ??
          new _$BusinessCardHolderUpdate._(
              token: token,
              active: active,
              notes: notes,
              ipAddress: ipAddress,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'BusinessCardHolderUpdate', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
