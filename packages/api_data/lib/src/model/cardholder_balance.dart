...
part 'cardholder_balance.g.dart';
...
/// * [lastUpdatedTime] 
@BuiltValue()
abstract class CardholderBalance implements Built<CardholderBalance, CardholderBalanceBuilder> {
  ...
  factory CardholderBalance([void updates(CardholderBalanceBuilder b)]) = _$CardholderBalance;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CardholderBalanceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CardholderBalance> get serializer => _$CardholderBalanceSerializer();
}

class _$CardholderBalanceSerializer implements PrimitiveSerializer<CardholderBalance> {
  @override
  final Iterable<Type> types = const [CardholderBalance, _$CardholderBalance];

  @override
  final String wireName = r'CardholderBalance';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CardholderBalance object, {
  ...
  void _deserializeProperties(
    ...
    required CardholderBalanceBuilder result,
  ...
  @override
  CardholderBalance deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CardholderBalanceBuilder();
