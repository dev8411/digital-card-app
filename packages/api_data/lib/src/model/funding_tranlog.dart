...
import 'package:api_data/src/model/internal_gpa_order.dart';
...
/// * [gatewayLog] 
@BuiltValue()
abstract class FundingTranlog implements Built<FundingTranlog, FundingTranlogBuilder> {
  ...
  @BuiltValueField(wireName: r'gpaorder')
  InternalGPAOrder get gpaorder;

  @BuiltValueField(wireName: r'gatewayLog')
  InternalGatewayLog get gatewayLog;

  FundingTranlog._();

  factory FundingTranlog([void updates(FundingTranlogBuilder b)]) = _$FundingTranlog;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FundingTranlogBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FundingTranlog> get serializer => _$FundingTranlogSerializer();
}

class _$FundingTranlogSerializer implements PrimitiveSerializer<FundingTranlog> {
  @override
  final Iterable<Type> types = const [FundingTranlog, _$FundingTranlog];

  @override
  final String wireName = r'FundingTranlog';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FundingTranlog object, {
    ...
    if (object.transactionState != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(FundingTranlogTransactionStateEnum),
      );
    }
    ...
    yield serializers.serialize(
      object.gpaorder,
      specifiedType: const FullType(InternalGPAOrder),
    );
    yield r'gatewayLog';
    yield serializers.serialize(
      object.gatewayLog,
  ...
  void _deserializeProperties(
    ...
    required FundingTranlogBuilder result,
      ...
      switch (key) {
        ...
        case r'transactionState':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(FundingTranlogTransactionStateEnum),
          ) as FundingTranlogTransactionStateEnum;
  ...
  @override
  FundingTranlog deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FundingTranlogBuilder();
...
class FundingTranlogTransactionStateEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'PENDING')
  static const FundingTranlogTransactionStateEnum PENDING = _$fundingTranlogTransactionStateEnum_PENDING;
  @BuiltValueEnumConst(wireName: r'CLEARED')
  static const FundingTranlogTransactionStateEnum CLEARED = _$fundingTranlogTransactionStateEnum_CLEARED;
  @BuiltValueEnumConst(wireName: r'COMPLETION')
  static const FundingTranlogTransactionStateEnum COMPLETION = _$fundingTranlogTransactionStateEnum_COMPLETION;
  @BuiltValueEnumConst(wireName: r'DECLINED')
  static const FundingTranlogTransactionStateEnum DECLINED = _$fundingTranlogTransactionStateEnum_DECLINED;
  @BuiltValueEnumConst(wireName: r'ERROR')
  static const FundingTranlogTransactionStateEnum ERROR = _$fundingTranlogTransactionStateEnum_ERROR;
  @BuiltValueEnumConst(wireName: r'ALL')
  static const FundingTranlogTransactionStateEnum ALL = _$fundingTranlogTransactionStateEnum_ALL;

  static Serializer<FundingTranlogTransactionStateEnum> get serializer => _$fundingTranlogTransactionStateEnumSerializer;

  const FundingTranlogTransactionStateEnum._(String name): super(name);

  static BuiltSet<FundingTranlogTransactionStateEnum> get values => _$fundingTranlogTransactionStateEnumValues;
  static FundingTranlogTransactionStateEnum valueOf(String name) => _$fundingTranlogTransactionStateEnumValueOf(name);
}
