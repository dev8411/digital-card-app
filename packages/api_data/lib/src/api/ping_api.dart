...
import 'package:api_data/src/model/echo_ping_response.dart';
import 'package:api_data/src/model/ping_response.dart';
...
class PingApi {
  ...
  Future<Response<PingResponse>> getPing({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EchoPingResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EchoPingResponse>> postPing({ 
    EchoPingRequest? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EchoPingRequest);
    ...
    EchoPingResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EchoPingResponse),
      ) as EchoPingResponse;
    ...
    return Response<EchoPingResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
