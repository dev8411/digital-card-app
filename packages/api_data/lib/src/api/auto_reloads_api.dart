...
import 'package:api_data/src/model/auto_reload_list_response.dart';
...
import 'package:api_data/src/model/auto_reload_update_model.dart';
...
class AutoReloadsApi {
  ...
  const AutoReloadsApi(this._dio, this._serializers);

  /// Lists all auto reloads for the program
  /// 
  ///
  /// Parameters:
  /// * [cardProduct] - Card product token
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AutoReloadListResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AutoReloadListResponse>> getAutoreloads({ 
    String? cardProduct,
    String? userToken,
    ...
    AutoReloadListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AutoReloadListResponse),
      ) as AutoReloadListResponse;
    ...
    return Response<AutoReloadListResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AutoReloadResponseModel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AutoReloadResponseModel>> getAutoreloadsToken({ 
    ...
    final _path = r'/autoreloads/{token}'.replaceAll('{' r'token' '}', token.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AutoReloadResponseModel? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AutoReloadResponseModel),
      ) as AutoReloadResponseModel;
    ...
    return Response<AutoReloadResponseModel>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AutoReloadResponseModel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AutoReloadResponseModel>> postAutoreloads({ 
    required AutoReloadModel body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AutoReloadModel);
  ...
  /// Returns a [Future] containing a [Response] with a [AutoReloadResponseModel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AutoReloadResponseModel>> putAutoreloadsToken({ 
    required String token,
    required AutoReloadUpdateModel body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AutoReloadUpdateModel);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
